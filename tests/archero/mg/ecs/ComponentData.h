#ifndef __mg_ComponentData_h__
#define __mg_ComponentData_h__
...
namespace mg
{
    ...
    {
    public:
        ComponentData(const DataUnit* data=nullptr);
        virtual ~ComponentData();
        bool operator ==(const ComponentData& rhs) const;
        bool operator !=(const ComponentData& rhs) const;
        ComponentData(const ComponentData& rhs);
        const ComponentData& operator =(const ComponentData& rhs);
...
#endif //#ifndef __mg_ComponentData_h__
