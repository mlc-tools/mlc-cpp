#ifndef __mg_Freezing_h__
#define __mg_Freezing_h__
...
namespace mg
{
    ...
    class Freezing : public ComponentBase
    {
    public:
        Freezing();
        virtual ~Freezing();
        bool operator ==(const Freezing& rhs) const;
        bool operator !=(const Freezing& rhs) const;
        Freezing(const Freezing& rhs);
        const Freezing& operator =(const Freezing& rhs);
...
#endif //#ifndef __mg_Freezing_h__
