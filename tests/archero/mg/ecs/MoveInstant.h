#ifndef __mg_MoveInstant_h__
#define __mg_MoveInstant_h__
...
namespace mg
{
    ...
    class MoveInstant : public ComponentMovement
    {
    public:
        MoveInstant();
        virtual ~MoveInstant();
        bool operator ==(const MoveInstant& rhs) const;
        bool operator !=(const MoveInstant& rhs) const;
        MoveInstant(const MoveInstant& rhs);
        const MoveInstant& operator =(const MoveInstant& rhs);
...
#endif //#ifndef __mg_MoveInstant_h__
