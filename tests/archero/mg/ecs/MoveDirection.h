#ifndef __mg_MoveDirection_h__
#define __mg_MoveDirection_h__
...
namespace mg
{
    ...
    class MoveDirection : public ComponentMovement
    {
    public:
        MoveDirection();
        ...
        bool operator !=(const MoveDirection& rhs) const;
        MoveDirection(const MoveDirection& rhs);
        const MoveDirection& operator =(const MoveDirection& rhs);
...
#endif //#ifndef __mg_MoveDirection_h__
