...
namespace mg
{
    ...
    AllTypes::AllTypes(const AllTypes& rhs)
    {

        this->operator=(rhs);
    }

    const AllTypes& AllTypes::operator =(const AllTypes& rhs)
    {

        this->int_value0 = rhs.int_value0;
        this->int_value1 = rhs.int_value1;
        this->float_value0 = rhs.float_value0;
        this->float_value1 = rhs.float_value1;
        this->bool_value0 = rhs.bool_value0;
        this->bool_value1 = rhs.bool_value1;
        this->str_value0 = rhs.str_value0;
        this->str_value1 = rhs.str_value1;
        this->int_list = rhs.int_list;
        this->float_list = rhs.float_list;
        this->bool_list = rhs.bool_list;
        this->string_list = rhs.string_list;
        this->int_string_map = rhs.int_string_map;
        this->float_string_map = rhs.float_string_map;
        this->bool_string_map = rhs.bool_string_map;
        this->string_string_map = rhs.string_string_map;
        this->string_int_map = rhs.string_int_map;
        this->string_float_map = rhs.string_float_map;
        this->string_bool_map = rhs.string_bool_map;
        this->object = rhs.object;
        this->object_ptr = rhs.object_ptr;
        this->object_list = rhs.object_list;
        this->object_ptr_list = rhs.object_ptr_list;
        this->object_map = rhs.object_map;
        this->object_ptr_map = rhs.object_ptr_map;
        this->enum_list = rhs.enum_list;
        this->enum_map = rhs.enum_map;
    ...
    void AllTypes::serialize_xml(SerializerXml& serializer) const
    {
        ...
        serializer.serialize(float_value1, "float_value1", float(0.0f));
    ...
    void AllTypes::deserialize_xml(DeserializerXml& deserializer)
    {
        ...
        deserializer.deserialize(float_value1, "float_value1", float(0.0f));
