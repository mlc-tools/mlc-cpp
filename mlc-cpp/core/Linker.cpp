...
void Linker::generateInlineFor(Class &cls) {
    ...
    //        }
    //        sup->subclasses.erase(std::remove(sup->subclasses.begin(),
    //        sup->subclasses.end(), std::make_shared<Class>(cls)),
    //        sup->subclasses.end());
    //    }
    //    cls.superclasses.erase(
    //        std::remove_if(cls.superclasses.begin(), cls.superclasses.end(),
    //        [](auto &s){ return s->isInline; }), cls.superclasses.end());
}
