...
private:
    ...
    virtual std::string getNotEqualMethodName() const override { return "__ne__"; }
    virtual std::string getCompareMethodPattern(const std::shared_ptr<Class> &cls, const Object &member) const override;
