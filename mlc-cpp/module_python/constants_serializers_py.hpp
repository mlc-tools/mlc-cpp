...
static const std::string META = R"__PY__(
...
static const std::string DATA_WRAPPER = R"__PY__(# -*- coding: utf-8 -*-
...
static const std::string INTRUSIVE = R"__PY__(# -*- coding: utf-8 -*-
...
static const std::string SERIALIZER_XML = R"__PY__(# -*- coding: utf-8 -*-
...
static const std::string DESERIALIZER_XML = R"__PY__(# -*- coding: utf-8 -*-
...
static const std::string DESERIALIZER_JSON = R"__PY__(# -*- coding: utf-8 -*-
from .Meta import Meta
from .BaseEnum import BaseEnum
from .DataWrapper import DataWrapper
from .IntrusivePtr import IntrusivePtr, make_intrusive
