...
const std::map<std::string, std::string> SERIALIZE_CPP_XML = {
    {"int_def", R"__(if($(FIELD) != $(DEFAULT_VALUE)){xml.append_attribute("$(FIELD)").set_value($(FIELD));})__"},
    {"int", R"__(xml.append_attribute("$(FIELD)").set_value($(FIELD));)__"},
    {"bool_def", R"__(if($(FIELD) != $(DEFAULT_VALUE)){xml.append_attribute("$(FIELD)").set_value($(FIELD));})__"},
    {"bool", R"__(xml.append_attribute("$(FIELD)").set_value($(FIELD));)__"},
    {"float_def", R"__(if($(FIELD) != $(DEFAULT_VALUE)){xml.append_attribute("$(FIELD)").set_value($(FIELD));})__"},
    {"float", R"__(xml.append_attribute("$(FIELD)").set_value($(FIELD));)__"},
    {"string_def", R"__(if($(FIELD) != $(DEFAULT_VALUE)){xml.append_attribute("$(FIELD)").set_value($(FIELD).c_str());})__"},
    {"string", R"__(xml.append_attribute("$(FIELD)").set_value($(FIELD));)__"},
    {"serialized", R"__($(FIELD).serialize_$(FORMAT)(xml.append_child("$(FIELD)"));)__"},
    {"pointer", R"__(
if($(FIELD))
{
...
const std::map<std::string, std::string> DESERIALIZE_CPP_XML = {
    {"int_def", R"__($(FIELD) = xml.attribute("$(FIELD)").as_int($(DEFAULT_VALUE));)__"},
    {"int", R"__($(FIELD) = xml.attribute("$(FIELD)").as_int();)__"},
    {"bool_def", R"__($(FIELD) = xml.attribute("$(FIELD)").as_bool($(DEFAULT_VALUE));)__"},
    {"bool", R"__($(FIELD) = xml.attribute("$(FIELD)").as_bool();)__"},
    {"float_def", R"__($(FIELD) = xml.attribute("$(FIELD)").as_float($(DEFAULT_VALUE));)__"},
    {"float", R"__($(FIELD) = xml.attribute("$(FIELD)").as_float();)__"},
    {"string_def", R"__($(FIELD) = xml.attribute("$(FIELD)").as_string($(DEFAULT_VALUE));)__"},
    {"string", R"__($(FIELD) = xml.attribute("$(FIELD)").as_string();)__"},
    {"serialized", R"__($(FIELD).deserialize_$(FORMAT)(xml.child("$(FIELD)"));)__"},
    {"pointer", R"__(
...
const std::string CPP_XML = R"__PROTOCOL__(
#list<int>
#serialize:
...
const std::string CPP_JSON = R"__PROTOCOL__(
